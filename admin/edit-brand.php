...
?>
	...
	<head>
		...
		<title>Ann Electric | Admin Edit Brand</title>
									...
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<form method="post" name="editbrand" class="form-horizontal">
												<?php
												$id = $_GET['id'];
												$ret = "SELECT * from tblbrand where id=:id";
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" class="form-control" value="<?php echo htmlentities($result->BrandName); ?>" name="brandname" id="brandname" required>
													</div>
												</div>
